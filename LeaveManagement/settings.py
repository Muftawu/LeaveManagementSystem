...
SECRET_KEY = 'django-insecure-*ax7z*r23g^!wu08dm%lqa0kzc8-k-l3)ma*-gv^e#8kwyqc3@'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR,'supervisor/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTHENTICATION_BACKENDS = ['accounts.authentication_backend.AuthenticationBackend']
